...
xsltproc --stringparam studyURI http://my.prefix.com/study/42 --output rdf-xml/DDI3.1-questionExample.rdf.xml 	../ddi-lifecycle/xsl/ddi3-1-to-rdf.xsl 	../ddi-examples/DDI3.1-questionExample.xml
