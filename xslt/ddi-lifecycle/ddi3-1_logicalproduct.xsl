...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="l:Variable">
        ...
        <rdf:Description>
            ...
            <rdf:type>
                <xsl:attribute name="rdf:resource"><xsl:value-of select="$discoURI"
    ...
    <xsl:template match="l:CodeScheme">
        <rdf:Description>
            ...
            <rdf:type>
                <xsl:attribute name="rdf:resource"
                    >http://www.w3.org/2004/02/skos/core#ConceptScheme</xsl:attribute>
            </rdf:type>
        </rdf:Description>
    </xsl:template>
    ...
    <xsl:template match="l:Category">
        <rdf:Description>
            ...
            <rdf:type>
                <xsl:attribute name="rdf:resource"
                    >http://www.w3.org/2004/02/skos/core#Concept</xsl:attribute>
            </rdf:type>
