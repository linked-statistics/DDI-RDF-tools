...
<!-- ddi3-1-util.xsl -->
<!-- utillities for conversions of DDI 3.1 intance to RDF -->
...
<xsl:stylesheet version="2.0"
  ...
  <!-- ================================ -->
  <!-- template createLanguageAttribute -->
  <!-- ================================ -->  
  ...
  <!-- ===================================== -->
  <!-- template createRdfsTypeRepresentation -->
  <!-- ===================================== -->  
  ...
  <!-- ================================== -->
  <!-- template createDiscoRepresentation -->
  <!-- ================================== -->
